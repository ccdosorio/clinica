...
const ReportConsultationFamily = (props) => {
  ...
  const getData = async () => {
    ...
    const res = await Https.post("consulta/report/family", options);
  ...
  const handleShow = async (event) => {
    ...
    const res = await Https.post("consulta/report/month", options);
    setData(res);
    setPage(page);
  };
              ...
              <div className="col-sm-12 col-md-6 mb-2">
                <div className="d-flex align-items-center">
                  <span className="mr-1 text-muted">
                    <b>Número de consultas: {numberRecords}</b>
                  </span>
                </div>
              </div>
            </div>
...
export default ReportConsultationFamily;
