...
const ReportPrescriptionInternal = (props) => {
  ...
  const getData = async () => {
    ...
    const res = await Https.post(
      "consulta/report/prescription/internal",
      options
    );
  ...
  const handeViewClick = async (value) => {
    props.history.push(
      `/prescription-detail/internal/${value.id}/${value.idconsulta}`
    );
  };
...
export default ReportPrescriptionInternal;
