...
const ReportConsultationDepartment = (props) => {
  ...
  const getData = async () => {
    ...
    const res = await Https.post("consulta/report/deparment", options);
    console.log(res);
    ...
    <div>
      <Breadcrumb
        routeSegments={[
          ...
          { name: "Consultas por departamento" },
        ]}
      ></Breadcrumb>
      <div className="row g-3">
        <div className="col-4">
          ...
          >
            ...
            <option value={909}>TI</option>
            <option value={101}>Finanzas</option>
          </select>
        </div>
...
export default ReportConsultationDepartment;
